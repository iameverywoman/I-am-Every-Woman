        ...
        <div className="row mt-5">
          <div className="col-md-12 card-faq mt-3 p-5">
            ...
            <p>
              ...
              is uniquely different from the Birdz in the ThugBirdz collection.
            </p>
            <p>
              The team has chosen just a single color for the background; a
              stunning shade of yellow. This background color offers an obvious
              distinction from those in the ThugBirdz collection.
            </p>
          </div>
          <div className="col-md-12 card-faq mt-3 p-5">
          ...
          <div className="col-md-12 card-faq mt-3 py-5">
            ...
            <p>
              Max Supply: 3,333 <br /> Price: 1 SOL <br /> Date: Tuesday, March
              8th 2022 at 8PM UTC <br /> Rarity Ranking: Initiated the day of
              launch <br /> Follow our communication channels for the latest
              updates!
            </p>
          </div>
        </div>
